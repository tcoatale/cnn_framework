...
#%%
def inception_resnet(input, classes):
  conv0 = conv2d([7, 7], 64, input, 'conv0', stride=3)
  print(conv0.get_shape())

  inception_res_block1 = inception_res_block(conv0, 'inception_res_block1')
  ...
  print(inception_res_block16.get_shape())
  
  output = average_pool_output([3, 3], classes, inception_res_block16, 'output_layer')
  
  return output

#%%
def resnet(input, classes):
  conv0 = conv2d([7, 7], 64, input, 'conv0', stride=3)
  print(conv0.get_shape())
  ...
  print(res_block16.get_shape())
  
  output = average_pool_output([3, 3], classes, res_block16, 'output_layer')
