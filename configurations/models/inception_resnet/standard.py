...
def architecture_start(input, add_filters, features):
  ...
  inc_res_block_1 = resnet_inception_block(pool2, 'inc_res_block_1')
  inc_res_block_2 = resnet_inception_block(inc_res_block_1, 'inc_res_block_2')
  inc_res_block_3 = resnet_inception_block(inc_res_block_2, 'inc_res_block_3')
  inc_res_block_4 = resnet_inception_block(inc_res_block_3, 'inc_res_block_4')
  pool5 = pool_layer(inc_res_block_4, 2, name='pool5')
  conv6 = conv2d_layer(pool5, [5, 5], 128, name='conv6')  
  inc_res_block_7 = resnet_inception_block(conv6, 'inc_res_block_7')
  inc_res_block_8 = resnet_inception_block(inc_res_block_7, 'inc_res_block_8')
  return inc_res_block_8
  
def architecture_end(input, add_filters, features):
  inc_res_block_9 = resnet_inception_block(input, 'inc_res_block_9')
  inc_res_block_10 = resnet_inception_block(inc_res_block_9, 'inc_res_block_10')
